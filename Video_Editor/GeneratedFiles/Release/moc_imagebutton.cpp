...
QT_MOC_LITERAL(1, 12, 9), // "setIsFade"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 40, 4), // "item"
QT_MOC_LITERAL(5, 45, 13) // "on_BtnClicked"

    },
    "ImageButton\0setIsFade\0\0QListWidgetItem*\0"
    "item\0on_BtnClicked"
};
...
void ImageButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setIsFade((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ImageButton::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageButton::setIsFade)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageButton::setIsFade(QListWidgetItem * _t1)
{
